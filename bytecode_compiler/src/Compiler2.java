...
public class Compiler2 {
    ...
    public Compiler2(String inputFilename, String outputFilename) {
    ...
    private void initOpcodes() {
        ...
        opcodes.put("pop", new Opcode(0x05, (scn, code) -> writeNoArgOpcode(code)));
        opcodes.put("call", new Opcode(0x06, (scn, code) -> writeSingleIntOpcode(scn, code)));
        ...
        opcodes.put("sreturn", new Opcode(0x33, (scn, code) -> writeNoArgOpcode(code)));
